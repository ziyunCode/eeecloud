...
<body class="page-orange">
	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content">
				<a class="menu-logo" href="/"><i class="icon icon-lg" >language</i>&nbsp;十一云服务</a>
				<ul class="nav">
					<li>
	...
	<!--这里替换crisp.chat的代码，如您不需要请把script标签删除-->
	 <script type="text/javascript"> window.$crisp=[];window.CRISP_WEBSITE_ID="b4e17a59-d8a4-4588-a452-91e93885e5ae";(function(){ d=document;s=d.createElement("script"); s.src="https://client.crisp.chat/l.js"; s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})(); </script>
