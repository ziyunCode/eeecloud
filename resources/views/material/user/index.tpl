												...
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                                                 ...
                                                 <!--       <p>两种方式导入所有节点</p>
                                                    ...
                                                    <div class="tab-pane fade" id="all_ssr_game">
														 <p><span class="icon icon-lg text-white">looks_one</span><a href="/ssr-download/SSTap.zip">点击我下载</a></p>
									...
									<div class="card-inner margin-bottom-no">
										...
										<dl class="dl-horizontal">
                                          ...
                                          {if $user->class!=0}
											...
											<dd><!--{$user->class}--><i class="icon icon-md t4-text">stars</i>&nbsp;<a href="//t.me/joinchat/AAAAAFJIitC9JYBjkRQhmg" target="view_window">点击加入TG群</a></dd>
                                          {else}
